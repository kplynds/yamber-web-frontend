...
const OldProfile = ({ user, logout, getAuthenticatedUserData, user_loading, redirectToSpotify, makePlaylistWithSpotifyData }) => {
...
export default connect(mapState, mapDispatch)(OldProfile);
